...
export JFROG_URL="https://cartert.jfrog.io"
...
#    - JFrog Platform Host: https://cartert.jfrog.io
...
gh workflow run "🔄-switch-platform.yml" \
  --field jpd_host="https://cartert.jfrog.io" \
...
```bash
cd bookverse-demo-init
export REGISTRY_SERVER='cartert.jfrog.io'       # JFrog hostname (without https://)
...
echo $JFROG_URL  # Should be: https://cartert.jfrog.io
